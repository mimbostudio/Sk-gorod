...
<div class="container">
	<div class="aboutkrovl">О промышленном альпинизме</div>
	<div class="aboutkrovl2">«ГОРОД» - одна из самых быстроразвивающихся строительных компаний, оказывающих свои услуги в Москве и Московской области.
Спектр работ, выполняемых нашей организацией, поистине широк, и может удовлетворить даже самого требовательного клиента!</div>
	...
	<div class="col-md-4 col-sm-6">
		<div class="krovlservice">
			...
			<div class="textservice">Мягкая рулонная кровля представляет собой плоскую или скатную кровлю, выполненную с применением рулонных кровельных битумных или полимерно-битумных материалов.
			</div>
