...
$result = mysql_query("UPDATE fasad SET name='$_POST[krovname]', ed='$_POST[kroved]', price='$_POST[krovprice]' WHERE id='$_POST[krovid]'");

$result = mysql_query("SELECT * FROM fasad WHERE id='$_POST[krovid]'");
