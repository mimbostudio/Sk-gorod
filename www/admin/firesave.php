...
$result = mysql_query("UPDATE fire SET name='$_POST[krovname]', ed='$_POST[kroved]', price='$_POST[krovprice]' WHERE id='$_POST[krovid]'");

$result = mysql_query("SELECT * FROM fire WHERE id='$_POST[krovid]'");
