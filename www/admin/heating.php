...
<style>#menu10{background:#1A242E;}</style>
<div class="bodydiv">
<?
...
$result = mysql_query("SELECT * FROM heating");
...
echo '</select>';
?>
<form action="uploadheating.php" id="myForm" method="post" enctype="multipart/form-data">
