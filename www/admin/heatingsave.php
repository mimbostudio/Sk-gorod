...
$result = mysql_query("UPDATE heating SET name='$_POST[krovname]', ed='$_POST[kroved]', price='$_POST[krovprice]' WHERE id='$_POST[krovid]'");

$result = mysql_query("SELECT * FROM heating WHERE id='$_POST[krovid]'");
