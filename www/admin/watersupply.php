...
<style>#menu8{background:#1A242E;}</style>
<div class="bodydiv">
<?
...
$result = mysql_query("SELECT * FROM watersupply");
...
echo '</select>';
?>
<form action="uploadwatersupply.php" id="myForm" method="post" enctype="multipart/form-data">
