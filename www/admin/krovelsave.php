...
$result = mysql_query("UPDATE krovel SET name='$_POST[krovname]', ed='$_POST[kroved]', price='$_POST[krovprice]' WHERE id='$_POST[krovid]'");

$result = mysql_query("SELECT * FROM krovel WHERE id='$_POST[krovid]'");
