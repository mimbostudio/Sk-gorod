...
<style>#menu3{background:#1A242E;}</style>
<div class="bodydiv">
<?
...
<form action="uploadkrov.php" id="myForm" method="post" enctype="multipart/form-data">
...
<br/><br/>
	  <div onclick="addfasad()" class="addvip">Добавить работу</div>
</form>
<div class="flcl"></div>
